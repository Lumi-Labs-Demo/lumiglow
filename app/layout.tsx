  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `(function(){try{if(localStorage.getItem('lumiglow-theme')==='dark')document.documentElement.setAttribute('data-theme','dark');}catch(e){}})();` }} />
      </head>
      <body>{children}</body>
    </html>
  );
